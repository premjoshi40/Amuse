  ...
  artworks: {
    ...
    sculptures: [
      ...
      },
      {
        ...
        year: 'c. 200 BC',
        image: 'https://upload.wikimedia.org/wikipedia/commons/thumb/1/14/Laocoon_Pio-Clementino_Inv1059-1064-1067.jpg/800px-Laocoon_Pio-Clementino_Inv1059-1064-1067.jpg',
        category: 'sculptures',
        location: 'Sculpture Hall - Ancient Greek Section',
        nfcCode: 'NFC010',
        qrCode: 'QR010',
        description: 'Ancient Greek marble sculpture depicting the Trojan priest Laocoön and his sons being attacked by sea serpents.',
        artist_info: 'Created by three sculptors from Rhodes: Agesander, Athenodoros, and Polydorus.',
        historical_context: 'Depicts a scene from Virgil\'s Aeneid, discovered in 1506 and influenced Renaissance artists.',
        techniques: 'Carved from multiple blocks of marble, showcasing Hellenistic drama and emotion',
        cultural_significance: 'Masterpiece of Hellenistic sculpture, influenced Michelangelo and Renaissance art',
        dimensions: '2.08 m tall',
        medium: 'Marble',
        provenance: 'Discovered in Rome in 1506, now in Vatican Museums',
        interesting_facts: [
          'Michelangelo rushed to see it when discovered',
          'Missing right arm was debated for centuries until found',
          'Inspired countless Renaissance and Baroque artists',
          'Considered the most famous ancient sculpture after its discovery'
        ]
      }
    ],
    ...
    historical: [
      ...
      },
      {
        ...
        year: '447-432 BC',
        image: 'https://upload.wikimedia.org/wikipedia/commons/thumb/c/ce/Elgin_Marbles_British_Museum.jpg/800px-Elgin_Marbles_British_Museum.jpg',
        category: 'historical',
        location: 'Ancient Civilizations Wing - Greek Section',
        nfcCode: 'NFC011',
        qrCode: 'QR011',
        description: 'Classical Greek marble sculptures from the Parthenon in Athens, representing scenes from Greek mythology.',
        artist_info: 'Overseen by Phidias, the greatest sculptor of ancient Greece, with his workshop artisans.',
        historical_context: 'Created during Athens\' Golden Age under Pericles as part of the Parthenon temple decoration.',
        techniques: 'High and low relief marble carving with extraordinary anatomical detail and flowing movement',
        cultural_significance: 'Pinnacle of Classical Greek art, influenced Western sculpture for millennia',
        dimensions: 'Various pieces, frieze originally 160 meters long',
        medium: 'Pentelic marble',
        provenance: 'Removed from Parthenon by Lord Elgin in early 1800s, now in British Museum',
        interesting_facts: [
          'Named after Lord Elgin who brought them to Britain',
          'Subject of ongoing repatriation debate with Greece',
          'Originally painted in bright colors',
          'Depict the Panathenaic procession honoring Athena'
        ]
      }
    ]
  },
